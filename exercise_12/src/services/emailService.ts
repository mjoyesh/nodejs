...
const orderPlacedMail = async (userEmail: string) => {
  const mailOptions = {
    from: `"Node Exercise" <${process.env.EMAIL_USER}>`,
    to: userEmail,
    subject: "Your order has been placed!",
    text: "Thank you for shopping!",
    html: "<strong>Thank you for signing up for our service!</strong>",
  }
...
module.exports = { sendWelcomeEmail, sendPromotionalEmail, orderPlacedMail }
